 ...
 * @author Rakib
 */
public class WhiteHouseVisitor_Visitee {
   ...
   public static class WhiteHouseCountMap extends Mapper<Object, Text, Text, IntWritable>
	      ...
	      private Text word = new Text();
	       ...
	       if (container.length > 19) {
                  ...
                  String visitorFirstName = container[1].trim();                  
                  String visitorLastName = container[0].trim();
                  
                   
                  String visiteeFirstName = container[20].trim();                  
                  String visiteeLastName = container[19].trim();
                  ...
                  if (!"visitee_namelast".equals(visiteeLastName) && !"namefirst".equals(visiteeFirstName)) {
                        String name = visitorLastName + "\t" + visitorFirstName + "\t" + visiteeLastName + "\t" + visiteeFirstName;
                        word.set(name);
	      ...
	      String[] container = value.toString().split("\t");
               ...
               if (container.length > 0) 
               {
                   ...
                   String containerValue = container[4].trim() + "\t" + container[0].trim() + "\t" + container[1].trim() +
                                                                 "\t" + container[2].trim() + "\t" + container[3].trim();
                   
                   visitorToRecordMap.put(Integer.parseInt(container[4].trim()), new Text(containerValue));
	       ...
	       if (container.length > 0) 
            ...
            countingJob.setJarByClass(WhiteHouseVisitor_Visitee.class);
            ...
            if (countingJob.waitForCompletion(true))
            {
                ...
                countingTopJob.setJarByClass(WhiteHouseVisitor_Visitee.class);
